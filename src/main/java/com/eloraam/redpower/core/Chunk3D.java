...
/**
 * Chunk3D - an integer-based way to keep track of and perform operations on
 * chunks in a Minecraft-based environment. This also takes in account the
 * dimension the chunk is in.
 * 
 * @author aidancbrady
 *
 */
public class Chunk3D {
	 ...
	 *            - chunk z location
	 * @param dimension
	 *            - the dimension this Chunk3D is in
	 */
	 ...
	 * 
	 * @param entity
	 *            - the entity to get the Chunk3D object from
	 */
	 ...
	 * 
	 * @param coord
	 *            - the Coord4D object to get this Chunk3D from
	 */
	 ...
	 * 
	 * @param world
	 *            - the world to get the Chunk object from
